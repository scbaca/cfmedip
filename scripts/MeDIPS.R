...
medips_function <- function(sample, bam, outdir, genome.relH.file, genome.GoGe.file) {
	...
	chr.select <- paste0("chr", c(1:22, "X", "Y", "M"))
	  ...
	  uniq = uniq, paired = TRUE, oneoutof=5000, 
#	  uniq = uniq, paired = TRUE, oneoutof=50, 
...
#	pdf(file.path(outdir, paste0(sample,".CpGcalibration.pdf"))) 
#	res <- MEDIPS.plotCalibrationPlot(CSet = CS, 
#	 main = paste0(sample, " CpG Calibration"), 
#	 MSet = medip, 
...
#tmp for debugging:
#arg_sample = "S013_809P"
#arg_bam = "analysis/bowtie2/S013_809P/S013_809P.dedup.bam"
#arg_outdir = " analysis/medips/S013_809P"
#genome.relH.file = "ref_files/bsgenome.hsapiens.ucsc.hg19_relH.rds"
#genome.GoGe.file = "ref_files/bsgenome.hsapiens.ucsc.hg19_GoGe.rds"
